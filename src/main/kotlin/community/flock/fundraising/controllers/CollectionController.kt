...
class CollectionController(
    ...
    @Value("\${flock.fundraising.donations.sepa.privateIdentification}")
    lateinit var sepaPrivateIdentification: String

    @Value("\${flock.fundraising.donations.sepa.message}")
    lateinit var sepaMessage: String

    @Value("\${flock.fundraising.donations.sepa.name}")
    lateinit var sepaName: String

    @Value("\${flock.fundraising.donations.sepa.iban}")
    lateinit var sepaIban: String

    @Value("\${flock.fundraising.donations.sepa.bic}")
    lateinit var sepaBic: String

    @Value("\${flock.fundraising.donations.sepa.address1}")
    lateinit var sepaAddress1: String

    @Value("\${flock.fundraising.donations.sepa.address2}")
    lateinit var sepaAddress2: String

    @Value("\${flock.fundraising.donations.sepa.country}")
